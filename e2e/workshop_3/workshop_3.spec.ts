...
test.skip("Adanced Interaction", async ({ page }) => {
  // open the target page
  await page.goto(
    "file:///Users/macbook/Documents/Work/TSC/Lean-E2E-Testing/E2E%20with%20PW/PlayWright/e2e/workshop_3/index.html",
  );
...
test.skip("Explore IFrame", async ({ page }) => {
  await page.goto(
    "file:///Users/macbook/Documents/Work/TSC/Lean-E2E-Testing/E2E%20with%20PW/PlayWright/e2e/workshop_3/index.html",
  );
